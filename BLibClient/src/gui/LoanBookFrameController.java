...
public class LoanBookFrameController {
    ...
    public void start(Stage primaryStage) throws Exception {
        FXMLLoader loader = new FXMLLoader(getClass().getResource("/gui/LoanBookFrame.fxml"));
        Parent root = loader.load();
        Scene scene = new Scene(root);
        scene.getStylesheets().add(getClass().getResource("/gui/LoanBookFrame.css").toExternalForm());
    ...
    @FXML
    private void onLoanBtnClick(ActionEvent event) {
